...
/// This factory generates a converter for types implementing <see cref="IPatchObject{T}"/>.
...
public class PatchJsonConverterFactory : JsonConverterFactory
{
    ...
    /// <returns>True if typeToConvert is <see cref="IPatchObject{T}"/></returns>
    public override bool CanConvert(Type typeToConvert)
    {
        return typeToConvert.IsGenericType &&
               typeToConvert.GetGenericTypeDefinition() == typeof(IPatchObject<>);
    }
    ...
    public override JsonConverter? CreateConverter(Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        var concreteTypeToConvert = PatchClassBuilder.Instance.GetPatchClassFor(baseObjectType);
    ...
    private class PatchObjectJsonConverter<TPatch, TObj> : JsonConverter<TPatch> where TPatch : IPatchObject<TObj>
    {
